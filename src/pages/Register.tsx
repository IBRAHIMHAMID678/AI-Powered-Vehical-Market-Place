    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 p-8 lg:p-16 flex flex-col justify-center">
        <div className="max-w-md">
          <p className="text-xs font-semibold tracking-wider text-foreground/70 mb-4">
          ...
          <p className="text-muted-foreground mb-8">
            Buy, sell & bid with AI Assistance
          </p>
          <div className="mt-8">
            <img
              src={carImage}
              alt="Silver Volkswagen Jetta"
        ...
        <div className="bg-card rounded-2xl shadow-lg p-8 w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 rounded-lg text-base font-medium border-border"
            >
            ...
            <p className="text-center text-sm text-card-foreground mt-6">
